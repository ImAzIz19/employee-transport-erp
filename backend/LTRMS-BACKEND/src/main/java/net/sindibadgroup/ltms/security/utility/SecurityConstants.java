package net.sindibadgroup.ltms.security.utility;

public class SecurityConstants {
    public static  final long JWT_ACCES_EXPIRATION = 1000 * 60 * 60 * 24;
    public static  final long JWT_REFRESH_EXPIRATION = 1000 * 60 * 60 * 24 * 7;
